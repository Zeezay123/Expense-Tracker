...
const PopOver = ({isshowPopFilter,setIsShowPopFilter, setSelectedType, setSelectedCategory}) => {
...
const cancelpop = () => (
  ...
  return(
  isshowPopFilter ? ( <div className='flex flex-col gap-4 bg-slate-50 w-[16.75rem] h-[15rem] rounded-lg shadow-md border-0'>
