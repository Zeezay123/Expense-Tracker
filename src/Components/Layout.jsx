  ...
  return (
     ...
     <div className='flex  h-screen bg-back relative'>
      ...
      { onTempMenu ? <div className='z-[99] h-full w-full absolute'> 
       ...
       { offSideMenu ? null : !smallMenu ? <div className='hidden lg:flex w-[18%] mr-0'>
   ...
   { onTempMenu ? <div className='flex relative overflow-hidden w-full'>   <div className='flex w-full ml-[60%] md:ml-[3%] h-full bg-black opacity-50 absolute z-[99]'onClick={offTempMenu} > full</div> <Outlet key={screenWidth} context={{onTempMenu, setOnTempMenu, offSideMenu, smallMenu, setSmallMenu}}/> </div> 
